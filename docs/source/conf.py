...
project = "uni-agent"
copyright = "2026, Uni-Agent Contributors"
author = "Yuyang Ding, Guangming Sheng"
...
# Use ../_static so that docs/_static (custom.css, js) is found when conf.py lives in source/
